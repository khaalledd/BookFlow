    ...
    <div className="bg-gradient-soft font-body-md text-on-surface min-h-screen flex flex-col overflow-x-hidden">
      ...
      <div className="flex-grow flex flex-col lg:flex-row min-h-screen">
        ...
        <main className="flex-1 flex flex-col px-margin py-4 lg:py-6 justify-center items-center z-10">
          {/* Logo */}
          <Link href="/" className="w-full max-w-lg mb-6 flex items-center gap-2 justify-center lg:justify-start hover:opacity-80 transition-opacity">
            <span
            ...
            <span className="font-h3 text-primary tracking-tighter text-xl">
              VerdantBook
            </span>
          </Link>
          ...
          <div className="w-full max-w-lg">
            ...
            <div className="glass-panel rounded-2xl p-6 md:p-8 space-y-6">
              <div className="text-center lg:text-left space-y-2 relative">
                <h1 className="font-h2 text-primary">Welcome Back</h1>
                <p className="font-label-sm text-on-surface-variant font-medium">
                  Sign in to your VerdantBook account.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex flex-col space-y-1.5">
                  <Label
                    htmlFor="email"
                    className="font-label-sm text-on-surface-variant font-semibold"
                  >
                    Email Address
                  </Label>
                  <Input
              ...
              <div className="relative flex items-center py-2">
                ...
                <span className="flex-shrink mx-md font-label-sm text-outline">
                  Or continue with
                </span>
                <div className="flex-grow border-t border-outline-variant/50"></div>
              </div>
            ...
            <footer className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4 px-2 pb-4">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="font-label-sm text-outline hover:text-primary transition-colors text-xs"
                >
                  Privacy Policy
                </a>
                <a
        ...
        <aside className="hidden lg:block lg:w-2/5 xl:w-1/3 relative bg-surface-container-high/30 overflow-hidden">
          ...
          <div className="relative h-full w-full flex flex-col items-start justify-center p-xl pl-2xl max-w-2xl">
            ...
            <h3 className="font-h1 text-primary-container leading-tight mb-md">
              Bring serenity to your bookings.
            </h3>
            <p className="font-body-lg text-secondary mb-xl">
              Join 5,000+ service providers who reclaimed their mental space
              with VerdantBook&apos;s focused interface.
            </p>
            ...
            <div className="grid grid-cols-2 gap-lg w-full">
              <div className="glass-panel p-lg rounded-xl border-t border-l border-white/60">
                ...
                <span className="text-sm text-on-surface-variant font-medium mt-1 block">
